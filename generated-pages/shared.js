...
const APP_VERSION = '26.06.05d'; // 格式：YY.MM.DD
...
const CHANGELOG = [
  {
    ...
    date: '2026-06-05',
    changes: [
      '【修正】進貨：待收清單新增「🚫 取消待收」按鈕，可針對單一品項取消剩餘待收（廠商不再交貨時使用），不影響同張訂單的其他品項',
      '【移除】訂貨：整筆訂單強制結案按鈕（設計有誤，已改為品項級操作）',
  ...
  },
  {
    ...
    changes: [
      ...
      '【修正】訂貨：進行中訂單的詳細卡片（含強制結案按鈕）HTML 容器補齊',
    ]
  },
  {
    version: '26.06.05a',
  ...
  },
  {
    ...
    date: '2026-06-05',
    changes: [
      '備盤防呆升級：選了未開封批號直接送出時，系統會擋下並提示先點「登記新開瓶」才能繼續',
      '備盤防呆升級：帳面量不足時的確認視窗，改為只看你選的那瓶，不再拿旁邊批號的量來湊數',
    ]
  },
  {
    version: '26.06.04',
