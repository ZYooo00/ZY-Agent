...
課程來源：https://github.com/lifehacker-tw/claude-code-mini-course
課程資源分三種：**教學文（docs）**、**武功秘笈（pro-kit）**、**技能書（skills）**
...
- [x] Pro-kit 01：AI 分身起始助手（建立屬於 ZY 的 AI 分身資料夾結構）
- [x] Pro-kit 02：Skill Creator 啟動（skill-creator 已安裝；第一個自訂 Skill 待下次建立）
- [ ] ⏳ 建立第一個自訂 Skill（方向：問題記錄 / 任務清單，待 ZY 確認具體使用情境後執行）
